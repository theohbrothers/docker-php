...
|:-------:|:---------:|
| `:8.5.0-fpm-alpine`, `:latest` | [View](variants/8.5.0-fpm-alpine) |
| `:8.5.0-fpm-alpine-opcache-mysqli-gd-pdo-memcached-sockets` | [View](variants/8.5.0-fpm-alpine-opcache-mysqli-gd-pdo-memcached-sockets) |
| `:8.5.0-fpm-alpine-opcache-mysqli-gd-pdo-memcached-sockets-xdebug` | [View](variants/8.5.0-fpm-alpine-opcache-mysqli-gd-pdo-memcached-sockets-xdebug) |
| `:8.4.15-fpm-alpine` | [View](variants/8.4.15-fpm-alpine) |
