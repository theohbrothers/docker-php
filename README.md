...
|:-------:|:---------:|
| `:8.2.10-fpm-alpine`, `:latest` | [View](variants/8.2.10-fpm-alpine) |
| `:8.2.10-fpm-alpine-opcache-mysqli-gd-pdo-memcached-sockets` | [View](variants/8.2.10-fpm-alpine-opcache-mysqli-gd-pdo-memcached-sockets) |
| `:8.2.10-fpm-alpine-opcache-mysqli-gd-pdo-memcached-sockets-xdebug` | [View](variants/8.2.10-fpm-alpine-opcache-mysqli-gd-pdo-memcached-sockets-xdebug) |
